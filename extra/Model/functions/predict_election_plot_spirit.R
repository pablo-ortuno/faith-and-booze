...
predict_election_plot_spirit <- function(year_to_predict)
  
{
  ...
  partisan_colors <- c("actually democrat" = "lightskyblue1", "actually republican" = "lightpink", "correctly democrat" = "blue3", "correctly republican" = "red3", "null" = "black")
  
  plot_usmap(data = election_pred , regions = "states", values = "pred_for_plot", color = "black") +
    labs( title = paste("States Predicted Correctly for", year_to_predict, 'Election'),
